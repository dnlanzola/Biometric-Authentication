...
def plot_scoreDist(gen_scores, imp_scores, plot_title):
    ...
    plt.show()
    plt.savefig(plot_title.split(",")[0] + "_SCOREDIST.png", bbox_inches="tight")
    plt.close()
    return
...
def plot_det(far, frr, plot_title):
    ...
    plt.show()
    plt.savefig(plot_title.split(",")[0] + "_DET.png", bbox_inches="tight")
    plt.close()
    return eer
...
def plot_roc(far, tpr, plot_title):
    ...
    plt.title(plot_title)
    plt.show()
    plt.savefig(plot_title.split(",")[0] + "_ROC.png", bbox_inches="tight")
    plt.close()
    return
